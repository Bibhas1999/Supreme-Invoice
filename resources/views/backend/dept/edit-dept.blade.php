                    ...
                    <section class="col-lg-12">
                        ...
                        <div class="card text-dark">
                            <div class="card-header">
                                <h5 class="text-center bg-sec rounded-lg shadow-lg py-2 px-2 font-weight-bold">EDIT DEPARTMENT
                                   
                                </h5> 
                            </div>
                            <div class="card-body">
                                <form role="form" method="POST" action="{{route('depts.update',$editData->id)}}">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <a class="btn btn-sm bg-danger" href="{{route('depts.view')}}" style="margin-top:32px">Cancel </a>
                                        </div>
                                    </div>
                                </form>
                            </div><!-- /.card-body -->
