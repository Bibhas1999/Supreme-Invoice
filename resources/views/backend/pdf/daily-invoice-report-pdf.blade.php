...
<div class="container">
    ...
    <table width="100%">
        <thead>
            <tr>
                <th width="100%" style="text-align:center;font-size:16px;"> Daily Invoice Report PDF
        ...
        <tbody>
         ...
         @if (count($allData) != null)
            ...
            <tr>
                ...
                <td class="ftd">{{ $invoice['payment']['customer']['name'] }}</td>
                <td class="ftd">{{ date('d-m-Y', strtotime($invoice->date)) }}</td>
               
                <td class="ftd">Rs. {{ $invoice['payment']['total_amount'] }}</td>
