        ...
        <div class="row justify-content-center ">
            <div class="col-sm-5">
                <div class="login-wrap px-4 py-4 shadow-lg border-rounded-circle bg-white"
                    ...
                    <a class="btn btn-sm bg-sec"  href="{{ route('home') }}"> <i
                            class="fas fa-chevron-left"></i><i class="fas fa-chevron-left"></i> Back</a>
                    <div class="icon d-flex align-items-center px-3 py-2 justify-content-center  ">
                    ...
                    <form method="POST" action="{{ route('switch-user-login', $user->id) }}" id="myForm">
                        @csrf
